...
def main_lasa(shape_name):
    ...
    mc = MC_ElMap(trajs, n=100, weighting='half-auto', spatial=0.33, shape=0.33, tangent=0.33, stretch=0.01, bend=0.01, ds=True)
    x = mc.setup_problem()
    mc.set_constraints(inds=cst_inds, csts=cst_pts)
    repro = mc.solve_problem()
    ...
    mc = MC_ElMap(trajs, n=100, weighting='half-auto', spatial=1.0, shape=0.0, tangent=0.0, stretch=0.01, bend=0.01, ds=True)
    x = mc.setup_problem()
    mc.set_constraints(inds=cst_inds, csts=cst_pts)
    repro = mc.solve_problem()
    ...
    mc = MC_ElMap(trajs, n=100, weighting='half-auto', spatial=0.0, shape=0.0, tangent=1.0, stretch=0.01, bend=0.01, ds=True)
    x = mc.setup_problem()
    mc.set_constraints(inds=cst_inds, csts=cst_pts)
    repro = mc.solve_problem()
    ...
    mc = MC_ElMap(trajs, n=100, weighting='half-auto', spatial=0.0, shape=1.0, tangent=0.0, stretch=0.01, bend=0.01, ds=True)
    x = mc.setup_problem()
    mc.set_constraints(inds=cst_inds, csts=cst_pts)
    repro = mc.solve_problem()
